...
export const getDeployedCommonSubgraphUrls = (
  chainId: number,
...
export const getDeployedAnalyticsSubgraphUrls = (
  ...
  switch (chainId) {
    ...
    case 137:
      return [
        'https://connext.bwarelabs.com/subgraphs/name/connext/nxtp-matic-v1-analytics',
      ]
    case 250:
      return [
...
export const getSubgraphIndex = (url: string): string | undefined => {
...
export const getSubgraphHealth = async (
  ...
  const healthUrl = getSubgraphIndex(url)
  if (!healthUrl) {
    return undefined
  }
